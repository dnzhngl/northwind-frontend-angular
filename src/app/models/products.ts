...
// *TypeScript'te Apiden gelen datayı sınırandırmak için class yerine interface kullanıyoruz. Class kullanıldığ zaman, bu classın çağırıldığı yerde her alan girilmese de uyarmaz, ancak interface kullandığımız zaman, bu interfacein kullanıldığı yerde herhangi bir field'ı boş bırakılırsa uyarır/hata verir.
